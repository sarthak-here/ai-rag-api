...
class TestDocuments:
    ...
    def test_create_document_empty_content_rejected(self, client: TestClient):
...
class TestQueries:
    def test_ask_returns_answer(self, client: TestClient):
    ...
    def test_ask_question_too_short_rejected(self, client: TestClient):
        r = client.post("/api/v1/queries/ask", json={"question": "Hi"})
        assert r.status_code == 422

    def test_summarize_not_found(self, client: TestClient):
